...
export class AddPacienteComponent implements OnInit {
  ...
  public loadForm() {
    ...
    if (!this.isAddForm()) this.loaddedForm();
  }
...
const FORM_KEYS = ['name', 'gender', 'birthdate', 'city', 'address', 'phone', 'email', 'country', 'cep',  'otherInfo', 'allergy', 'userMedicine', 'medicineDescription', 'diabetic', 'hypertensive', 'heartDisease', 'pneumonia', 'asthma', 'hyperthyroidism', 'smoking', 'alcoholism'];
